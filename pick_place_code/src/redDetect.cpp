...
void VisionDetect::cloud_cb(const sensor_msgs::PointCloud2ConstPtr& input){
	...
	std::uint32_t rgb_filter1 = ((std::uint32_t)150<<16  | (std::uint32_t)0<<8  | (std::uint32_t)0);
	std::uint32_t rgb_filter2 = ((std::uint32_t)255<<16  | (std::uint32_t)5<<8 | (std::uint32_t)5);
	...
	//pcl::io::savePCDFileASCII ("wholescene_red.pcd", *cloud);
	//pcl::io::savePCDFileASCII ("cola_red.pcd", *cloud_filter_coke);
